figure(1)
BlandAltmanPlot1(r2(1:490),r5(1:490))
%%绘图
figure_FontSize=12;
xlabel('Average of triangle geometry resolution method and 3DMFCMeasurer','FontWeight','bold');
...
axis([-10,30,0,50]);
ylim([-30,15]);
title('Rocker Shoe Bland Altman')

% figure(2)
% BlandAltmanPlot1(F1(1:521),F2(1:521))
% %%绘图
% figure_FontSize=12;
% xlabel('Average of triangle geometry resolution method and 3DMFCMeasurer','FontWeight','bold');
% ylabel('Difference(mm)','FontWeight','bold');
...
% set(findobj('FontSize',12),'FontSize',figure_FontSize);
% % xlim([0,25]);
% title('Flat Shoe Bland Altman')



function h=BlandAltmanPlot1(var1, var2, varargin)
