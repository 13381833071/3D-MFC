...
Data = xlsread("C:\Users\zzs\Desktop\文章\chenhao\最新标记点CT到步态实验室每一帧的转换矩阵\zhangxingyu_transMAT_three_6_f2.xlsx");%帧之间的转换矩阵
Data2 = xlsread("C:\Users\zzs\Desktop\文章\chenhao\最新标记点CT到步态实验室每一帧的转换矩阵\zhangxingyu_transMAT_three_6.xlsx");%帧之间的转换矩阵
...
gait_data=load('C:\Users\zzs\Desktop\文章\chenhao\10分钟帧数据仅步态数据\zhangxingyu_01.csv');
z6=gait_data(:,18);
dt=0.01;
